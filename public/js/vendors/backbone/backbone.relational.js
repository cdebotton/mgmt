...
(function(root, factory) {
  ...
  if (typeof exports !== 'undefined') {
	...
	Backbone.HasMany = Backbone.Relation.extend({
			...
			if ( this.keyContents ) {
				...
				if ( this.keyContents instanceof Backbone.Collection ) {
					...
					_.each( this.keyContents || [], function( item ) {
							...
							if ( model && !this.related._byCid[ model.cid ] && !this.related.get( model ) ) {
								models.push( model );
							}
						}, this );
				}
		...
		tryAddRelated: function( model, options ) {
			options = this.sanitizeOptions( options );
			if ( !this.related._byCid[ model.cid ] && !this.related.get( model ) ) {
		...
		addRelated: function( model, options ) {
			...
			model.queue( function() { // Queued to avoid errors for adding 'model' to the 'this.related' set twice
				if ( dit.related && !dit.related._byCid[ model.cid ] && !dit.related.get( model ) ) {
	...
	Backbone.Collection.prototype.add = function( models, options ) {
		...
		_.each( models || [], function( model ) {
			...
			if ( model instanceof Backbone.Model && !this.get( model ) && !this._byCid[ model.cid ] ) {
	...
	Backbone.Collection.prototype.remove = function( models, options ) {
		...
		_.each( models || [], function( model ) {
				model = this._byCid[ model.cid ] || this.get( model );
